...
# https://m.facebook.com/nobeta.nobi.suke.33886305
...
\033[1;97m            @@@тАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАв@@@ \033[1;0m
\033[1;97m           @@@тАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАв@@@ \033[1;0m
\033[1;97m          @@@тАвтАвтАвтАвтАвтАвтАвтАвтАвтАвЁЭРБЁЭРеЁЭРЪЁЭРЬЁЭРдтАвтАвтАвтАвтАвтАвтАв@@@ \033[1;0m
\033[1;97m         @@@тАвтАвтАвтАвтАвтАвтАвтАвЁЭРйЁЭРЪЁЭРзЁЭРнЁЭРбЁЭРЮЁЭРлтАвтАвтАвтАвтАвтАв@@@ \033[1;0m
\033[1;97m        @@@тАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАв@@@ \033[1;0m
\033[1;97m       @@@тАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАв@@@ \033[1;0m
\033[1;97m      @@@тАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАв@@@ \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93mтЮд\033[1;97m Author   : ЁЭРБЁЭРеЁЭРЪЁЭРЬЁЭРд-ЁЭРйЁЭРЪЁЭРзЁЭРнЁЭРбЁЭРЮЁЭРл
\033[1;93mтЮд\033[1;97m Github   : https://github.com/NOBITA2023
\033[1;93mтЮд\033[1;97m Fb Id  : https://www.facebook.com/nobeta.nobi.suke.33886305
\033[1;97m--------------------------------------------------
"""
...
def tech_abm():
    ...
    if username =="black":
        os.system("clear")
        print logo
        print ("[+] Username : black (Correct)")
        passwordss = raw_input("\033[1;97m[+]\033[1;97m Password :\033[1;97m ")
        if passwordss =="panther":
            os.system("clear")
            print logo
            logging()
            os.system("clear")
            print logo 
            print ("\033[1;97m[+]\033[1;92m Username : black\033[1;92m (Correct)")
            print ("\033[1;97m[+]\033[1;92m Password : panther\033[1;92m (Correct)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
            print('')
	    ...
	    os.system('xdg-open https://m.facebook.com/nobeta.nobi.suke.33886305')
            time.sleep(1)
            tech_abm()
    else:
	...
	os.system('xdg-open https://m.facebook.com/nobeta.nobi.suke.33886305')
        time.sleep(1)
        ЁЭРБЁЭРеЁЭРЪЁЭРЬЁЭРд_ЁЭРйЁЭРЪЁЭРзЁЭРнЁЭРбЁЭРЮЁЭРл()
...
def login_choice():
    ...
    os.system('clear')
    print logo
    print ("\033[1;97m[1]\033[1;91m-тЛД-\033[1;97mRandom Search Name Cloning     \033[1;97m(\033[1;92mno login\033[1;97m) ")
    print ("\033[1;97m[2]\033[1;91m-тЛД-\033[1;97mRandom Ph.Number Cloning       \033[1;97m(\033[1;92mno login\033[1;97m) ")
    print ("\033[1;97m[3]\033[1;91m-тЛД-\033[1;97mClone Friendlist and Public ID \033[1;97m(\033[1;92mlogin\033[1;97m)    ")
    print ("\033[1;97m[0]\033[1;91m-тЛД-\033[1;97mExit") 
    print("\033[1;97m--------------------------------------------------")
    clone_main()
def clone_main():
    hack = raw_input("\nтХ░тФАтЮг ")
...
def loginvia():
    ...
    os.system('clear')
    print logo
    print ("\033[1;97m[1]\033[1;91m-тЛД-\033[1;97mlogin With Access Token ")
    print ("\033[1;97m[2]\033[1;91m-тЛД-\033[1;97mLogin With User And Pass")
    print ("\033[1;97m[0]\033[1;91m-тЛД-\033[1;97mBack") 
    print("\033[1;97m--------------------------------------------------")
    clone_loginvia()
def clone_loginvia():
    hack = raw_input("\nтХ░тФАтЮг ")
	...
	print("\033[1;97m--------------------------------------------------")
        ...
        sav.write(token)
        sav.close()
        abm("\r\033[1;92m[тЬУ] Login Successfull\033[0;97m")
...
def loginfb():
    ...
    if "access_token" in q:
        ...
        succ.close()
        print("\n\033[1;92m[тЬУ] Login Successfull\033[0;97m")
        time.sleep(1)
        menu()
    else:
...
def menu():
    ...
    print("\033[1;97m--------------------------------------------------")
    print("\033[1;97m[1]\033[1;91m-тЛД-\033[1;97mClone Frienlist and Public ID")
    print("\033[1;97m[2]\033[1;91m-тЛД-\033[1;97mClone Bangladesh and India")
    print("\033[1;97m[0]\033[1;91m-тЛД-\033[1;97mlogout")
    print("\033[1;97m--------------------------------------------------") 
    menu_select()
def menu_select():
    option = raw_input("\nтХ░тФАтЮг ")
    ...
    if option =="2":
        ...
        os.system("rm -rf .login.txt")
        time.sleep(1)
        print("\033[1;92m[тЬУ] Logged Out Successfully\033[0;97m")
        os.system("exit")
    else:
        print("[!] Please Select a Valid Option")
        menu_select()
...
def crack():
	...
	os.system("python3 .loading.md")
        os.system('clear')
        print logo
	print ("\033[1;97m[1]\033[1;91m-тЛД-\033[1;97mCrack From Friend List")
	print ("\033[1;97m[2]\033[1;91m-тЛД-\033[1;97mCrack From Public ID")
	print ("\033[1;97m[3]\033[1;91m-тЛД-\033[1;97mCrack From Followers")
	print ('\033[1;97m[0]\033[1;91m-тЛД-\033[1;97mBack')
	print("\033[1;97m--------------------------------------------------")
	crack2()
def crack2():
...
def bangla_india():
    ...
    os.system('clear')
    print logo
    print("\033[1;97m[1]\033[1;91m-тЛД-\033[1;97mRandom Bangladesh Cloning")
    print("\033[1;97m[2]\033[1;91m-тЛД-\033[1;97mRandom India Cloning")
    print("\033[1;97m[0]\033[1;91m-тЛД-\033[1;97mBack")	
    print("\033[1;97m--------------------------------------------------")
    bangla_india_man()
...
def bangla():
	...
	print("\033[1;97m--------------------------------------------------")
	print ("\033[1;97m[1]\033[1;91m-тЛД-\033[1;93mCrack From Friend List")
	print ("\033[1;97m[2]\033[1;91m-тЛД-\033[1;93mCrack From Public ID")
	print ("\033[1;97m[3]\033[1;91m-тЛД-\033[1;93mCrack From Followers")
	print ('\033[1;97m[0]\033[1;91m-тЛД-\033[1;93mBack')
	print("\033[1;97m--------------------------------------------------")
	bangla2()
def bangla2():
	select = raw_input("\nтХ░тФАтЮг ")
